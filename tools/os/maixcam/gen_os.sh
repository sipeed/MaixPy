...
cp -r ../../../projects/maixcam_apps/* tmp/sys_builtin_files/maixapp/apps
...
cd -
if [ -d $MAIXCDK_PATH/projects/maixcam_apps/ ]; then
    cp -r $MAIXCDK_PATH/projects/maixcam_apps/* tmp/sys_builtin_files/maixapp/apps
fi
