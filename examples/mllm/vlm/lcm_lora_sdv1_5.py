...
t = time.time()
import numpy as np
print('import np cost:', time.time() - t); t = time.time()
import onnxruntime
print('import onnxruntime cost:', time.time() - t); t = time.time()
import torch
print('import torch cost:', time.time() - t); t = time.time()
from PIL import Image
print('import PIL cost:', time.time() - t); t = time.time()
from transformers import CLIPTokenizer, PreTrainedTokenizer
print('import transformers cost:', time.time() - t); t = time.time()
from diffusers.models.autoencoders.vae import DiagonalGaussianDistribution
from diffusers.models.modeling_outputs import AutoencoderKLOutput
from diffusers.utils import load_image, make_image_grid
from diffusers.utils.torch_utils import randn_tensor
print('import diffusers cost:', time.time() - t); t = time.time()
############ Img2Img
