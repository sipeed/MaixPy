...
| MaixCAM2     | ![maixcam2\_io](https://wiki.sipeed.com/hardware/assets/maixcam/maixcam2_pins.jpg)                                     | First name like `A2` is the pin name; `GPIOA2/SPI1_CS0` is the function name | See [Hardware Docs](https://wiki.sipeed.com/hardware/zh/maixcam/maixcam2.html)    |
