...
# 2. caulate the mean value of each 2x2 block, and replace the original image
img = src_img.copy()
img.midpoint_pool(2, 2)
img.save("out/out_midpoint_pool.jpg")

# 3. caulate the midpoint pool value of each 2x2 block, and return a new image
...
# 4. caulate the mean value of each 2x2 block, and return a new image
img = src_img.copy()
